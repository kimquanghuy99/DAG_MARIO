...
void CPlatform2::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void CPlatform2::OnCollisionWith(LPCOLLISIONEVENT e)
{
	if (!e->obj->IsBlocking()) return;
	if (dynamic_cast<CPlatform2*>(e->obj)) return;
